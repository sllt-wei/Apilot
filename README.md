## 一个基于[ChatGPT-on-Wechat](https://github.com/zhayujie/chatgpt-on-wechat)以及[dify-on-wechat]项目的简单插件，直接调用一些实用的api接口！
...
```
#installp https://github.com/sllt-wei/Apilot.git
```
